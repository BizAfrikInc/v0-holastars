"use client"
import { Camera, Eye, EyeOff, Loader2, Lock, Save, Shield } from "lucide-react"
...
const ProfilePage = () => {
  const { authenticated, userRolesPermissions, registeredBusiness, updateUserRolesPermissions, updateRegisteredBusiness } = useAuthStore();
