  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Hola Stars custom color scheme
        brand: '#38BDF8', // sky-400
        'brand-hover': '#FBBF24', // amber-400
      ...
      backgroundImage: {
        ...
        'hero-gradient': 'linear-gradient(to right, #38BDF8, #0EA5E9)',
        'premium-gradient': 'linear-gradient(to right, #38BDF8, #0EA5E9)',
      }
    }
  },
